...
namespace Modelo.Migrations
{
    ...
    partial class SistemaColegioModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entidades.Boletin", b =>
                {
                    ...
                    b.Property<bool>("BoletinCerrado1")
                        .HasColumnType("bit");

                    b.Property<bool>("BoletinCerrado2")
                        .HasColumnType("bit");

                    b.Property<bool>("BoletinCerrado3")
                        .HasColumnType("bit");
                    ...
                    b.Property<decimal>("PromedioAsistenciaTrimestre1")
                        .HasColumnType("decimal(4, 1)");

                    b.Property<decimal>("PromedioAsistenciaTrimestre2")
                        .HasColumnType("decimal(4, 1)");

                    b.Property<decimal>("PromedioAsistenciaTrimestre3")
                        .HasColumnType("decimal(4, 1)");

                    b.Property<decimal>("PromedioTotalAsistencia")
                        .HasColumnType("decimal(4, 1)");

                    b.Property<decimal>("PromedioTotalExamenes")
                        .HasColumnType("decimal(4, 1)");
            ...
            modelBuilder.Entity("Entidades.Cuota", b =>
                {
            ...
            modelBuilder.Entity("Entidades.EstadoCuota", b =>
                {
            ...
            modelBuilder.Entity("Entidades.Opcion", b =>
                {
            ...
            modelBuilder.Entity("Entidades.Pago", b =>
                {
                    ...
                    b.Property<string>("ApellidoPagador")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CodigoDeComprobante")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DniPagador")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Entidades.PagoDeCuota", b =>
                {
                    b.Property<int>("PagoDeCuotaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PagoDeCuotaId"));
            ...
            modelBuilder.Entity("Entidades.RolUsuario", b =>
                {
                    b.Property<int>("RolUsuarioId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entidades.TipoDePago", b =>
                {
                    b.Property<int>("TipoDePagoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TipoDePagoId"));
            ...
            modelBuilder.Entity("Entidades.Pago", b =>
                {
                    b.HasOne("Entidades.TipoDePago", "TipoDePago")
                        .WithMany("Pagos")
            ...
            modelBuilder.Entity("Entidades.PagoDeCuota", b =>
                {
                    ...
                    b.HasOne("Entidades.Cuota", "Cuota")
                        .WithMany()
                        .HasForeignKey("CuotaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entidades.EstadoCuota", "EstadoCuota")
                        .WithMany("PagosDeCuota")
                        .HasForeignKey("EstadoCuotaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entidades.Pago", "Pago")
                        .WithMany()
            ...
            modelBuilder.Entity("Entidades.Permiso", b =>
                {
                    b.HasOne("Entidades.Opcion", "Opcion")
                        .WithMany("Permiso")
                        .HasForeignKey("OpcionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entidades.RolUsuario", "RolUsuario")
                        .WithMany("Permiso")
